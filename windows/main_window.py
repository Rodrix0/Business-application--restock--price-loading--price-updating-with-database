...
class MainWindow(QWidget):
    ...
    def initUI(self):
        ...
        self.label_imagen.setObjectName("HeaderBanner")
        ...
        if not pixmap.isNull():
            pixmap = pixmap.scaled(160, 110, Qt.KeepAspectRatio)
            logo = QLabel()
            logo.setPixmap(pixmap)
            logo.setAlignment(Qt.AlignCenter)
            banner_layout.addWidget(logo)
        self.label_imagen.setLayout(banner_layout)
        ...
        section_title = QLabel("Menú Principal")
        ...
        self.layout.addWidget(self.ingresar_btn, alignment=Qt.AlignCenter)
        self.setLayout(self.layout)
    ...
    def mostrar_pantalla_opciones(self):
        ...
        self.label_opciones.setStyleSheet("font-size: 20px;")
    ...
    def mostrar_pantalla_vender(self):    
        ...
        self.label_vender.setStyleSheet("font-size: 20px;")
        ...
        self.entry_buscar_vender.setStyleSheet("font-size: 18px;")
        ...
        self.entry_buscar_vender.setClearButtonEnabled(True)
        # Hacer foco al entrar para escaneo inmediato
        self.entry_buscar_vender.setFocus()
        ...
        self.treeview_vender.setAlternatingRowColors(True)
        self.treeview_vender.verticalHeader().setVisible(False)
        self.treeview_vender.horizontalHeader().setStretchLastSection(True)
        self.treeview_vender.horizontalHeader().setDefaultSectionSize(240)
        self.treeview_vender.horizontalHeader().setMinimumSectionSize(120)
        # Pasos de scroll más pequeños
        self.treeview_vender.verticalScrollBar().setSingleStep(12)
        self.treeview_vender.horizontalScrollBar().setSingleStep(12)
        ...
        self.combo_metodo_pago.setStyleSheet("")
        ...
        self.treeview_lista_venta.setAlternatingRowColors(True)
        self.treeview_lista_venta.verticalHeader().setVisible(False)
        self.treeview_lista_venta.horizontalHeader().setStretchLastSection(True)
        self.treeview_lista_venta.horizontalHeader().setDefaultSectionSize(220)
        self.treeview_lista_venta.horizontalHeader().setMinimumSectionSize(120)
        self.treeview_lista_venta.verticalScrollBar().setSingleStep(12)
        self.treeview_lista_venta.horizontalScrollBar().setSingleStep(12)
        self.layout.addWidget(self.treeview_lista_venta)
        self.label_total = QLabel("Total: $0.00")
        self.label_total.setStyleSheet("font-size: 28px; font-weight: bold;")
